import { Button, Dialog, DialogHeader, DialogFooter, DialogBody, Tooltip } from '@material-tailwind/react'
    ...
    <div>
      {
        cart.length > 0
          ...
          (
            <Fragment>
              <Dialog
                className="border-0 outline-0 overflow-y-auto  max-h-[90%]  scrollbar-hide"
                open={openModal}
